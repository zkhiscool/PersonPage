...
function render(data) {
    const $itemArr = data.map(obj => {
        ...
        $iconSpan.innerHTML = `<svg class="icon icon-delete" aria-hidden="true"><use xlink:href="#icon-delete"></use></svg><svg class="icon icon-delete" aria-hidden="true"><use xlink:href="#icon-edit"></use></svg>`
        $h2.append($iconSpan)
